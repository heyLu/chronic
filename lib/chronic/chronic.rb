module Chronic
  class << self
    ...
    def pre_normalize(text) #:nodoc:
      ...
      normalized_text.gsub!(/\b#{t :TODAY}\b/, 'this day')
      normalized_text.gsub!(/\b#{t :TOMORROW}\b/, 'next day')
      normalized_text.gsub!(/\b#{t :YESTERDAY}\b/, 'last day')
      normalized_text.gsub!(/\b#{t :NOON}\b/, '12:00')
      normalized_text.gsub!(/\b#{t :MIDNIGHT}\b/, '24:00')
      normalized_text.gsub!(/\b#{t :BEFORE_NOW}\b/, 'past')
      normalized_text.gsub!(/\b#{t :NOW}\b/, 'this second')
      normalized_text.gsub!(/\b#{t :AGO_BEFORE}\b/, 'past')
      normalized_text.gsub!(/\b#{t :THIS_PAST}\b/, 'last')
      normalized_text.gsub!(/\b#{t :THIS_LAST}\b/, 'last')
      normalized_text.gsub!(/\b#{t :MORNINGS}\b/, '\1')
      normalized_text.gsub!(/\b#{t :DAYTIMES}\b/, '\1')
      normalized_text.gsub!(/\b#{t :TONIGHT}\b/, 'this night')
      normalized_text.gsub!(/\b\d+:?\d*[ap]\b/,'\0m')
      normalized_text.gsub!(/(\d)([ap]m|oclock)\b/, '\1 \2')
      normalized_text.gsub!(/\b#{t :FUTURES}\b/, 'future')
